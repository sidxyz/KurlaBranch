  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="background-color:#763A7A; margin-bottom:10px; padding:-10px; border-radius:3px;">
      ...
      <ul class="nav navbar-nav navbar-right">
         <li>
           <a href="SignUpPage" style="text-decoration:underline;padding:15px;" class="hvr-bounce-to-bottom"><i></i>Sign up</a>
         </li>
         <li>
           <a href="SignInPage" style="text-decoration:underline;padding:15px;" class="hvr-bounce-to-bottom"><i></i>Sign in</a>
         </li>
          </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
